...
Future<String> getHeartRate(String startdate, String enddate) async {
  ...
  final url=Uri.parse('https://j84m7pylze.execute-api.us-east-2.amazonaws.com/getHeartRate/getHeartRate');
...
Future<String> saveHeartRate(String collect_date) async {
  ...
  final url=Uri.parse('https://j84m7pylze.execute-api.us-east-2.amazonaws.com/saveHeartRate/saveHeartRate');
  final response = await http.post(url,
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8'
      },
